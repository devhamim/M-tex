...
Route::get('/our/promise', [FrontendController::class, 'our_promise'])->name('our.promise');
...
Route::get('/api/subcategories/{category}', [SubcategoryController::class, 'getSubcategories']);
        Route::resources([
