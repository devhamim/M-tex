        ...
        <ul class="sidebar-menu scrollable">
            ...
            <li class="sidebar-item">
                ...
                <ul class="sidebar-link-group">
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('category.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-solid fa-eject"></i></span> <span class="sidebar-txt">Category</span></a>
                    </li>
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('subcategory.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-solid fa-eject"></i></span> <span class="sidebar-txt">Subcategory</span></a>
                    </li>
                    <li class="sidebar-dropdown-item">
